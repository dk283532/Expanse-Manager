package com.example.expanse.Covid
...
import kotlinx.android.synthetic.main.item_list_dor_covid.view.*
...
class StateAdapter(val list: List<StatewiseItem>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view = convertView?: LayoutInflater.from(parent?.context).inflate(R.layout.item_list_dor_covid,parent,false)
